      ...
      <div className="flex  max-sm:flex-col">
        <div className="w-7/12 max-sm:w-11/12 ">
          ...
          >
            <input
              ...
              className="transition duration-500 hover:scale-105 bg-transparent w-6/12 max-sm:w-9/12 h-10 border-2 border-slate-400 pl-3 rounded-md"
              name="name"
              required
              minLength="3"
              maxLength="20"
            ...
            <input
              ...
              className="transition duration-500 ease-in-out hover:scale-105 bg-transparent w-6/12 max-sm:w-9/12 h-10 border-2 border-slate-400 pl-3 mt-3 rounded-md"
              name="email"
              required
              minLength="8"
              maxLength="20"
            ...
            <textarea
              ...
              cols="30"
              rows="10"
              className="transition duration-500 hover:scale-105 bg-transparent w-6/12 max-sm:w-9/12 border-2 border-slate-400 pl-3 mt-3 rounded-md"
              name="message"
            ...
            <input
              type="submit"
              className="transition duration-500 hover:scale-105 mt-10 bg-indigo-900  rounded-3xl text-xl py-3 px-5 max-sm:py-1 max-sm:px-3 rounded-3xl text-sm"
        ...
        <div className="w-4/12 max-sm:w-11/12 max-sm:mt-8 ">
          <div className="flex flex-col items-center">
            <div className="w-full max-sm:w-9/12 h-28  pt-2 border-2 border-indigo-900 rounded-md">
            ...
            <div className="w-full max-sm:w-9/12 h-28  border-2 border-indigo-900 mt-8 rounded-md">
              <div className="flex flex-row ml-3 mt-2">
            ...
            <div className="w-full max-sm:w-9/12 h-28 pt-2 border-2 border-indigo-900 mt-8 rounded-md ">
              <div className="flex flex-row ml-3 mt-2">
